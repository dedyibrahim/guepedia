...
<?php $kategori= $this->db->get('kategori_naskah'); foreach($kategori->result_array() as $kate){ ?>    
    <a class=" col-sm-4" href="<?php echo base_url('Strore/kategori/'. base64_encode($kate['id_kategori_naskah'])) ?>"><div class="dropdown-item"> <span class="fa fa-book"></span> <?php echo $kate['nama_kategori'] ?> </div></a>
...
<input class="form-search mr-md-6 col-md-12 " type="search" placeholder="Cari Buku . . " aria-label="Cari Buku">
</form>
